            ...
            <div className="mt-10 text-white space-y-8">
              <div>
                <p className="mt-1 leading-7">
                  <span className="underline">Stellar amusement</span> <br /> As
                  we release our first part of the entertainment platform we
                  will provide our <br /> holders with more usability for their
                  Froggies Token <br />
                  <br />{" "}
                  <span className="underline">NFT with galactic use-case</span>
                  <br />
                  ...
                  <br /> Prepare for the Ultimate Destination by starting the
                  development of something <br /> unique (we cannot disclose,
                  others are watching). This will put Froggies Token on <br />{" "}

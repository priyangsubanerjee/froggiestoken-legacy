...
function FuelingSuccess({
  ...
  return (
    <div>
      <Fade when={expandingHorizonsModalOpen} duration={500}>
        {expandingHorizonsModalOpen && (
              ...
              <div className="mt-10 text-white space-y-8">
                <div>
                  <p className="mt-1 leading-7 font-poppins">
                    ...
                    &apos;Ultimate Destination&apos; project, the universe{" "}
                    <br /> will be enlightened with our plans, all eyes will be
                    on FROGGIES Token. <br />
                    <br /> Valued on all planets <br /> We will continue
                    collaborations with third parties to turn FROGGIES Token
                    into a <br /> means of real-life payments. Envision online
                    stores where you can check-out <br /> using your Froggies
                    Token! <br />
